--user : r1807101
--password : p101
--create user f1807101 identified by p101;
--grant all privileges to f1807101;
...
insert into employee (emp_id, emp_name, gender, emp_email, designation, emp_address, phone_no) values (11, 'Hayden King',        'Male',   'audra29@hagenes.com',   'Cashier',                      '29 Cummings Heights',          '47260145292' );
insert into employee (emp_id, emp_name, gender, emp_email, designation, emp_address, phone_no) values (12, 'Travis Gray ',       'Male',   'sawayn@hotmail.com ',   'Front Office Manager',         '326 Wilfridshire Ports',       '82953780510' );
insert into employee (emp_id, emp_name, gender, emp_email, designation, emp_address, phone_no) values (13, 'Madeleine Campbell', 'Female', 'vjerde@reinger.com',    'Reservation Clerk',            '95 South Peggiestad',          '17477417890' );
insert into employee (emp_id, emp_name, gender, emp_email, designation, emp_address, phone_no) values (14, 'Emanuel Wood',       'Male',   'june61@gmail.com ',     'Receptionist',                 '47 North Fern',                '19925061626' );
...
insert into customer (cust_id, cust_name, cust_email, NID_no, cust_address, phone_no) values (06, 'Zayn Harris',       'kuvalis.chandler@hotmail.com',    '67890',     '303 Boyd Ports Suite',    '585.521.8079' );
insert into customer (cust_id, cust_name, cust_email, NID_no, cust_address, phone_no) values (07, 'Gael Anderson',     'lakin.doug@abernathy.net',        '78901',     '94 Boyd Ports Suite',     '619-807-7852' );
insert into customer (cust_id, cust_name, cust_email, NID_no, cust_address, phone_no) values (08, 'Tyson Waters',      'danderson@gmail.com',             '89012',     '70 Boyd Ports Suite',     '683-558-3478' );
...
insert into customer (cust_id, cust_name, cust_email, NID_no, cust_address, phone_no) values (10, 'Sophie Wood',       'elliott.watsica@hotmail.com',     '01234',     '19 Boyd Ports Suite',     '1716-527-8495');
...
insert into customer (cust_id, cust_name, cust_email, NID_no, cust_address, phone_no) values (24, 'Leah Hamilton',     'bettie81@yahoo.com',              '90123',     '65 Boyd Ports Suite',     '969.846.3483' );
insert into customer (cust_id, cust_name, cust_email, NID_no, cust_address, phone_no) values (25, 'Sophie Wood',       'elliott.watsica@hotmail.com',     '01234',     '85 Boyd Ports Suite',     '1716-527-8495');
commit;
--ROOM Table
